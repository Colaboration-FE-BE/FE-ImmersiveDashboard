    ...
    <div className=" grid grid-flow-row gap-4">
      <div className=" flex gap-3 justify-end">
        <div className=" px-3 py-1 bg-gray-300 rounded-lg justify-center items-center gap-1 inline-flex">
          <input
            placeholder="Search.."
            className=" rounded-lg p-1 text-slate-300 text-xs font-medium bg-white "
          />
          <img
            onClick={handleClick}
      ...
      <div className="flex flex-row justify-end">
        <div className=" flex gap-5">
          <select className="w-44 h-10  rounded-md border border-gray-200 bg-white text-slate-500">
